...
import com.ynjabo77.jaboojbackjudgeservice.judge.codesandbox.CodeSandboxFactory;
import com.ynjabo77.jaboojbackjudgeservice.judge.codesandbox.CodeSandboxProxy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        // 1 传入题目的提交id，获取到对应的题目、提交信息(包含代码、编程信息等)
